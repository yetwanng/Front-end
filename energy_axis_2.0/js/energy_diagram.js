...
//画出能带
function drawBlock(axisX, blockBottom, blockTop) {

    var blockWidth = energyBlockWidth;
    var blockHeight =VERTICAL_TICK_SPACING *( blockBottom-blockTop);
    var colors = ['#16a085', '#27ae60', '#2c3e50', '#f39c12', '#e74c3c', '#9b59b6', '#FB6964', '#342224', "#472E32", "#BDBB99", "#77B1A9", "#73A857"];
    var color = Math.floor(Math.random() * colors.length);

    context.beginPath();
    var my_gradient=context.createLinearGradient((energyBlockWidth+energyBlockSpace)*axisX + HORIZONTAL_AXIS_MARGIN,-blockBottom*VERTICAL_TICK_SPACING+VERTICAL_AXIS_MARGIN,(energyBlockWidth+energyBlockSpace)*axisX + HORIZONTAL_AXIS_MARGIN,-blockBottom*VERTICAL_TICK_SPACING+VERTICAL_AXIS_MARGIN+blockHeight);
    var blockColor = document.getElementById("colors").value;;
    my_gradient.addColorStop(0,blockColor);
    my_gradient.addColorStop(1,"white");
    context.fillStyle = my_gradient;
    context.fillRect( (energyBlockWidth+energyBlockSpace)*axisX + HORIZONTAL_AXIS_MARGIN, -blockBottom*VERTICAL_TICK_SPACING+VERTICAL_AXIS_MARGIN,blockWidth,blockHeight);
    context.stroke();
}
